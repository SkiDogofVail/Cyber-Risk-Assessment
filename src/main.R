...
sheeturl <- rstudioapi::showPrompt(
  ...
  message = 'Enter the URL to your google sheet.',
   default = "https://docs.google.com/spreadsheets/d/11tKjCAsliFCmu6aXJbLkc8MIaHqlJ_DGqXnQYyCpnLg/edit#gid=2113505539")
# default = "https://docs.google.com/spreadsheets/d/11tKjCAsliFCmu6aXJbLkc8MIaHqlJ_DGqXnQYyCpnLg/edit#gid=2113505539")
#   default = "https://docs.google.com/spreadsheets/d/1aFW1iUAJX7jFlrLXlj956F2wGIP_aqdR8pK7YYkL2Yo/edit#gid=2113505539")
...
gEstimates <- read_sheet(sheeturl, sheet = "api_stage", skip = 10)
gEstimates2 <- read_sheet(sheeturl, sheet = "api_stage_2", skip = 9)
gScope <- read_sheet(sheeturl, sheet = "Scope", skip = 3)
gCommentary <- read_sheet(sheeturl, sheet = "Commentary")
gJournal <- read_sheet(sheeturl, sheet = "Journal")
gSumstats <- read_sheet(sheeturl, sheet = "sumstats")
